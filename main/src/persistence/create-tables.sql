...
CREATE TABLE IF NOT EXISTS
  PUBLIC.TAG (
    ...
    UPDATED_AT TIMESTAMPTZ,
    USER_ID UUID NOT NULL,
    CONSTRAINT OPERATION_ID FOREIGN KEY (OPERATION_ID) REFERENCES PUBLIC.OPERATION (OPERATION_ID) ON UPDATE NO ACTION ON DELETE NO ACTION CONSTRAINT TAG_PKEY PRIMARY KEY (TAG_ID),
    CONSTRAINT TAG_KEY_ID FOREIGN KEY (TAG_KEY_ID) REFERENCES PUBLIC.TAG_KEY (TAG_KEY_ID) ON UPDATE NO ACTION ON DELETE NO ACTION,
    CONSTRAINT TAG_VALUE_ID FOREIGN KEY (TAG_VALUE_ID) REFERENCES PUBLIC.TAG_VALUE (TAG_VALUE_ID) ON UPDATE NO ACTION ON DELETE NO ACTION,
    CONSTRAINT USER_ID FOREIGN KEY (USER_ID) REFERENCES PUBLIC.USER (USER_ID) ON UPDATE NO ACTION ON DELETE NO ACTION
  );
